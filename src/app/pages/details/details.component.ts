...
export class DetailsComponent implements OnInit, OnDestroy {
    ...
    darkModeStatusSubscription: Subscription = new Subscription();
    citiesSubscription: Subscription = new Subscription();

    tweets$: Observable<any> = new Observable<any>();
    ...
    ngOnInit() {
        this.darkModeStatusSubscription = this.uiService.darkModeState.subscribe((isDark) => {
        ...
        this.citiesSubscription = this.activeRouter.paramMap
    ...
    ngOnDestroy() {
        this.darkModeStatusSubscription.unsubscribe();
